...
to decide which JRuby-Rack version you may need to use. While warbler is compatible with multiple jruyb-rackversions, it does not
know your target webserver, so you may need to further restrict your JRuby-Rack version
...
-  <b>Jruby-Rack version not compatible with JRuby version</b>
   ...
   - Consult {JRuby-Rack compatibility}[https://github.com/jruby/jruby-rack#compatibility]
