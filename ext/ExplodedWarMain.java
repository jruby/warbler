 ...
 * </pre>
 */
public class ExplodedWarMain extends JarMain {

    static final String MAIN = '/' + ExplodedWarMain.class.getName().replace('.', '/') + ".class";
    ...
    ExplodedWarMain(final String[] args) {
        super(args);
    ...
    private URL extractWebserver() throws Exception {
        this.webroot = new File(this.warRoot.toString(), "WEB-INF");
        debug("webroot directory is " + this.webroot.getPath());

        File jarFile = new File(this.webroot, "webserver.jar");
    ...
    protected int launchJRuby(final URL[] jars) throws Exception {
        ...
        invokeMethod(scriptingContainer, "setCurrentDirectory", warRoot.getAbsolutePath());
    ...
    protected String locateExecutable(final Object scriptingContainer) throws Exception {
        ...
        final File exec = new File(warRoot, executable);
        if ( exec.exists() ) {
    ...
    protected CharSequence executableScriptEnvPrefix() {
        final String gemsDir = new File(warRoot, "WEB-INF/gems").getAbsolutePath();
        final String gemfile = new File(warRoot, "WEB-INF/Gemfile").getAbsolutePath();
        ...
        "require '" + warRoot + "/META-INF/init.rb'";
    }
...
//        invokeMethod(scriptingContainer, "setHomeDirectory", this.warRoot.toString());
        invokeMethod(scriptingContainer, "setHomeDirectory", "uri:classloader:/META-INF/jruby.home");
    }

    @Override
    protected int start() throws Exception {
        this.warRoot = new File("/Users/kovyrin/Downloads/enterprise-search-7.9.0-exploded/lib/war");
        final URL[] jars = {};
    ...
    public static void main(String[] args) {
        doStart(new ExplodedWarMain(args));
    }
}
